      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "32px 24px" }}>
        ...
        {goal && goal.tracking !== "none" && (
          <>
            ...
            <ImagePlaceholder width={120} height={120} radius={4} label="[photo]" />
            <div style={{ flex: 1 }}>
...
function ImagePlaceholder({ width, height, radius = 8, label }) {
  return (
    <div
      style={{
        width,
  ...
  return (
    ...
    >
      <div style={{ position: "relative", overflow: "hidden" }}>
        ...
        >
          <ImagePlaceholder width={258} height={220} radius={0} label="[dish photo]" />
        </div>
        <span
          style={{
            position: "absolute",
...
function RestaurantCard({ name, rating, reviews, meta, bookedToday, times, goalAligned }) {
  const [hovered, setHovered] = useState(false);
  return (
    <div
      onMouseEnter={() => setHovered(true)}
    ...
    >
      <div style={{ overflow: "hidden", position: "relative" }}>
        ...
        >
          <ImagePlaceholder width={258} height={132} radius={0} label="[restaurant photo]" />
        </div>
        {goalAligned && (
          <span
            style={{
    ...
    <div style={{ fontFamily: FONT, minHeight: "100vh", background: C.white }}>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 24px" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          <ScrollCarousel>
            {BOOK_TODAY_RESTAURANTS.map((r) => (
              <RestaurantCard key={r.name} {...r} goalAligned={Boolean(goal && r.goalAligned)} />
            ))}
          </ScrollCarousel>
        </div>
        ...
        <div style={{ marginBottom: 40 }}>
          ...
          <ScrollCarousel>
            {(dishes || GOAL_DISHES.balanced).map((d) => (
...
function SearchResultCard({ r, goal, onNavigate }) {
  const [hovered, setHovered] = useState(false);
  return (
    <div
      onMouseEnter={() => setHovered(true)}
      ...
      <div style={{ position: "relative", flexShrink: 0 }}>
        <div style={{ overflow: "hidden", borderRadius: 8 }}>
          <div style={{ transition: "transform .3s", transform: hovered ? "scale(1.05)" : "scale(1)" }}>
            <ImagePlaceholder width={220} height={160} radius={0} label="[restaurant photo]" />
          </div>
        </div>
...
function ConciergeRestaurantCard({ r, onNavigate }) {
  const [hovered, setHovered] = useState(false);
  return (
    <div
      onMouseEnter={() => setHovered(true)}
    ...
    >
      <div style={{ position: "relative", flexShrink: 0 }}>
        <ImagePlaceholder width={106} height={106} radius={4} label="[photo]" />
          ...
          <div ref={scrollRef} style={{ flex: 1, overflowY: "auto", padding: "16px", maxWidth: 748, margin: "0 auto", width: "100%", boxSizing: "border-box" }}>
            {messages.map((m, mi) => (
              <div key={mi} style={{ display: "flex", flexDirection: "column", gap: 16, marginBottom: 32 }}>
                ...
                <div>
                  {m.restaurants.map((r) => (
                    <ConciergeRestaurantCard key={r.name} r={r} onNavigate={onNavigate} />
                  ))}
                </div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "24px 24px 40px", display: "flex", gap: 32 }}>
        <div style={{ flex: "1 1 600px", minWidth: 0 }}>
          ...
          {SEARCH_RESULTS.map((r) => (
            <SearchResultCard key={r.name} r={r} goal={goal} onNavigate={onNavigate} />
          ))}
        </div>
      ...
      <div style={{ maxWidth: 1280, margin: "0 auto", padding: "40px 24px", display: "flex", gap: 48 }}>
        <div style={{ flex: 1, maxWidth: 680 }}>
          ...
          <div style={{ display: "flex", gap: 16, marginBottom: 20 }}>
            <ImagePlaceholder width={160} height={160} radius={4} label="[restaurant photo]" />
            <div>
